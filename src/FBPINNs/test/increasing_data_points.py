...
def plot_DDD_varying_DataPoints():
    ...
    # Varying parameters
    # numxs = np.arange(10, 101, 10)
    numxs = np.arange(100, 501, 100) 
    ...
    parentdir = "Increase_DataPoints"
    rootdirs = ["Increase_DataPoints_sg", "Increase_DataPoints_coexistence", "Increase_DataPoints_survival"]
