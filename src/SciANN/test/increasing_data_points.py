...
parent_output_path = os.path.join(os.getcwd(), f'INCREASING_DATA_POINTS_{args.epochs[0]}/')
...
def plot_varying_DataPoints():
    ...
    for model_type in model_types:
        output_path = os.path.join(parent_output_path, f'INCREASING_DATA_POINTS_{model_type.upper()}/')
